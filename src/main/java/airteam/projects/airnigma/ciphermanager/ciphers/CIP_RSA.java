...
public class CIP_RSA extends CipherObject {
	...
	public String encode(String text) throws Exception {
		...
		try {
			...
			throw new Exception("Przekroczono maksymalną długość szyfrowanej wiadomości!");
		} catch (Exception e) {
			throw new Exception("Nie można zakodować szyfru! Upewnij się, że wprowadzono odpowiedni klucz publiczny!");
		}
	}
	...
	public String decode(String text) throws Exception {
		...
		try {
			...
			throw new Exception("Nie można odczytać szyfru! Upewnij się, że wprowadzono odpowiedni klucz prywatny!");
		}
	}
